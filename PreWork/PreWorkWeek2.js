...
function exercise1(num1) {
 ...
 // In the case where varA= 2 and varB= "2" wont pass the test. Because, they are equal but not identical. 
 // varA is a number and varB is a String. This example does not apply for booleans or null.
  ...
  // I found this somewhat difficult I used my notes and google to check the typeof.
